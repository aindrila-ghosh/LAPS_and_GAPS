...
def explain_point_global(oversampled_data, model_features, categorical_features, numeric_features, budget=999, show_pos_neg = False):
  ...
  ## calculate feature difference matrix
    ...
    for row_index in range(0,len(sorted_index_combinations)):
    ...
    #print("feature_difference calculated")
